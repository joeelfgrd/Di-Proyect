...
class Ui_venPrincipal(object):
    def setupUi(self, venPrincipal):
        ...
        self.Pprincipal.setGeometry(QtCore.QRect(350, 230, 80, 25))
        self.Pprincipal.setMinimumSize(QtCore.QSize(80, 25))
        self.Pprincipal.setMaximumSize(QtCore.QSize(80, 25))
        self.Pprincipal.setObjectName("Pprincipal")
        self.lblTitulo = QtWidgets.QLabel(parent=self.centralwidget)
        self.lblTitulo.setGeometry(QtCore.QRect(250, 140, 281, 51))
        font = QtGui.QFont()
